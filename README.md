...
<h1 align="center" dir="rtl" lang="ar">
<br>
  <a href="https://github.com/leonardomso/33"><img src="https://i.imgur.com/dsHmk6H.jpg" alt="٣٣ مفهوم يجب أن يعرفهم كل مطور JavaScript" width=200"></a>
  <br>
    <br>
...
It is based on an article written by [Stephen Curtis](https://twitter.com/stephenthecurt) and you can read it [here](https://medium.com/@stephenthecurt/33-fundamentals-every-javascript-developer-should-know-13dd720a90d1).
...
1. **[Call Stack](#١-call-stack)**
2. **[Primitive Types](#٢-primitive-types)**
3. **[Value Types and Reference Types](#٣-value-types-and-reference-types)**
4. **[Implicit, Explicit, Nominal, Structuring and Duck Typing](#٤-implicit-explicit-nominal-structuring-and-duck-typing)**
5. **[== vs === vs typeof](#٥--vs--vs-typeof)**
   6 **[Function Scope, Block Scope and Lexical Scope](#٦-function-scope-block-scope-and-lexical-scope)**
6. **[Expression vs Statement](#٧-expression-vs-statement)**
7. **[IIFE, Modules and Namespaces](#٨-iife-modules-and-namespaces)**
8. **[Message Queue and Event Loop](#٩-message-queue-and-event-loop)**
9. **[setTimeout, setInterval and requestAnimationFrame](#١٠-settimeout-setinterval-and-requestanimationframe)**
10. **[JavaScript Engines](#١١-javascript-engines)**
11. **[Bitwise Operators, Type Arrays and Array Buffers](#١٢-bitwise-operators-type-arrays-and-array-buffers)**
12. **[DOM and Layout Trees](#١٣-dom-and-layout-trees)**
13. **[Factories and Classes](#١٤-factories-and-classes)**
14. **[this, call, apply and bind](#١٥-this-call-apply-and-bind)**
15. **[new, Constructor, instanceof and Instances](#١٦-new-constructor-instanceof-and-instances)**
16. **[Prototype Inheritance and Prototype Chain](#١٧-prototype-inheritance-and-prototype-chain)**
17. **[Object.create and Object.assign](#١٨-objectcreate-and-objectassign)**
18. **[map, reduce, filter](#١٩-map-reduce-filter)**
19. **[Pure Functions, Side Effects and State Mutation](#٢٠-pure-functions-side-effects-and-state-mutation)**
20. **[Closures](#٢١-closures)**
21. **[High Order Functions](#٢٢-high-order-functions)**
22. **[Recursion](#٢٣-recursion)**
23. **[Collections and Generators](#٢٤-collections-and-generators)**
24. **[Promises](#٢٥-promises)**
25. **[async/await](#٢٦-asyncawait)**
26. **[Data Structures](#٢٧-data-structures)**
27. **[Expensive Operation and Big O Notation](#٢٨-expensive-operation-and-big-o-notation)**
28. **[الخوارزميات](#٢٩-الخوارزميات)**
29. **[Inheritance, Polymorphism and Code Reuse](#٣٠-inheritance-polymorphism-and-code-reuse)**
30. **[Design Patterns](#٣١-design-patterns)**
31. **[Partial Applications, Currying, Compose and Pipe](#٣٢-partial-applications-currying-compose-and-pipe)**
32. **[كتابة كود نظيف](#٣٣-كتابة-كود-نظيف)**
...
### تعلم ECMAScript 6 درس 43# - تعرف على Call Stack و Web API و Event Loop و Callback Queue
* قناة: Elzero Web School
* [تعلم ECMAScript 6 درس 43# - تعرف على Call Stack و Web API و Event Loop و Callback Queue](https://www.youtube.com/watch?v=uaphx2xjDKc&list=PLDoPjvoNmBAy3siU1b04xY24ZlstofO9M)

 * قناة: Ammar AbdElKarem
* [كورس JAVASCRIPT - Call Stack & Memory Heap يعنى ايه](https://www.youtube.com/watch?v=u8tqw2I-PBU)

 * قناة: Shadow Coding
* [Javascript Call Stack and Memory Heap Arabic (2) | javascript شرح | javascript behind the scenes](https://www.youtube.com/watch?v=DcbUY-dVDPk&t=11s)


### مقالات  
* شرح Event Loop و Call Stack ودورهما في جافا سكريبت
*  [اقرأ المقالة على Tutomena](https://www.tutomena.com/javascript-event-loop)
* [الرابط البديل على حسوب](https://io.hsoub.com/javascript/107709-%D8%B4%D8%B1%D8%AD-event-loop-%D9%88-call-stack-%D9%88%D8%AF%D9%88%D8%B1%D9%87%D9%85%D8%A7-%D9%81%D9%8A-%D8%AC%D8%A7%D9%81%D8%A7-%D8%B3%D9%83%D8%B1%D9%8A%D8%A8%D8%AA)
* المؤلف: عيسى بوكرن
...
**[⬆ العودة إلى الأعلى](#مجتمع-المطورين)**
...
- 📜 [3Mastering the JavaScript "this" Keyword — Aakash Srivastav](https://dev.to/aakashsr/mastering-the-javascript-this-keyword-4pfa)
...
## ٢٨. Expensive Operation and Big O Notation
...
## ٣٠. Inheritance, Polymorphism and Code Reuse
...
- 📜 [كتابة كود نظيف - Dylan Paulus](https://dev.to/ganderzz/on-writing-clean-code-57cm)
- 📜 [كتابة كود نظيف وممارسة البرمجة - Nityesh Agarwal](https://dev.to/nityeshaga/writing-clean-code-and-the-practice-of-programming-actionable-advice-for-beginners-5f0k)
